...
`       See the top of the file for details.
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        # true_expert_ph = tf.placeholder(tf.bool, (), name="true_expert")
        ...
        #         gradients = optimizer.compute_gradients(weighted_error, var_list=expert_vars[i])
        ...
        #     else:
        #         optimize_expr = optimizer.minimize(weighted_error, var_list=expert_vars[i])
