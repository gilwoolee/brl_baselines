...
def build_train(make_obs_ph, make_bel_ph, q_func, num_experts, num_actions, optimizer,
    expert_optimizer,
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        def optimize(i):
            if grad_norm_clipping is not None:
                gradients = expert_optimizer.compute_gradients(weighted_error, var_list=expert_vars[i])
                ...
                optimize_expr = expert_optimizer.minimize(weighted_error, var_list=expert_vars[i])
        ...
        expert_train = U.function(
            ...
            outputs=[expert_td_error],
            updates=[selected_expert_optimize_expr]
        )
        ...
        return act_f, train, expert_train, update_target, {'q_values': q_values}
