...
try:
    ...
    MPI = None
from brl_baselines.bpo_expert_no_residual.runner import Runner
...
def learn(*, network, env, total_timesteps, expert, eval_env = None, seed=None, nsteps=2048, ent_coef=0.0, lr=3e-4,
