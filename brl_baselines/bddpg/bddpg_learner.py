...
class BDDPG(object):
    def __init__(self, actor, critic, experts, obs_dim, memory, observation_shape, action_shape,
        ...
        self.normalized_critic_tf = critic(normalized_obs0, self.obs0[:, self.obs_dim:], self.actions, expert_qv0)
        ...
        self.normalized_critic_with_actor_tf = critic(normalized_obs0, self.obs0[:, self.obs_dim:], self.actor_tf, expert_qv0_with_actor_tf)
        ...
        self.Q_obs1 = target_critic(normalized_obs1, self.obs1[:, self.obs_dim:], action1, expert_qv1)
