...
from brl_baselines.bddpg.bddpg_learner import BDDPG
from brl_baselines.bddpg.pretrain_experts import ExpertLearner

from brl_baselines.bddpg.models import Actor, Critic, ExpertCritic
from brl_baselines.bddpg.memory import Memory, ExpertMemory, ExpertActorMemory
from brl_baselines.bddpg.pretrain_actors import ActorLearner
from brl_baselines.bddpg.noise import AdaptiveParamNoiseSpec, NormalActionNoise, OrnsteinUhlenbeckActionNoise
...
def learn(network, env,
    ...
    for epoch in range(nb_epochs):
        ...
        print("return", np.mean(epoch_episode_rewards))
