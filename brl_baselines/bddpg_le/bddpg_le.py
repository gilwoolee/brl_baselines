    ...
    for epoch in range(nb_epochs):
        ...
        for cycle in range(nb_epoch_cycles):
            ...
            for t_rollout in range(nb_rollout_steps):
                ...
                expert = np.array([info['expert'] for _info in info])
                # if epoch > 20 :
                #     print("Store transition")
                agent.store_transition(obs, action, r, new_obs, done, expert) #the batched data will be unrolled in memory.py's append.
